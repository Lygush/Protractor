...
public:
    ...
    // нажатие, разбудившее МК, не считается кликом — GButton в это время
    // не тикает и ничего не видит; таймер бездействия сбрасывает
    // reset_activity(), вызываемый отдельно после выхода из сна.
    void enter_sleep();
